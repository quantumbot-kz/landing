      ...
      innerHTML: JSON.stringify({
        ...
        '@graph': [
          ...
          },
          {
            ...
            operatingSystem: 'Web',
            url: app.appUrl,
            description: 'Каспи бот для продавцов Kaspi.kz: обновление цен от 1 минуты, автоснижение и автоповышение, умный предзаказ. После регистрации доступны 3 дня бесплатной подписки. От 19 990 ₸/мес.',
