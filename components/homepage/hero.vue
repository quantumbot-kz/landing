  ...
  <div id="top" class="hero">
    <div class="container">
      ...
      <p class="hero__subtitle">
        Каспи бот следит за конкурентами на Kaspi.kz и сам делает автоснижение и автоповышение цен. Ниже минимума по товару не опустится. От 19 990 ₸/мес, 3 дня бесплатно.
      </p>
