  ...
  <div id="top" class="hero">
    <div class="container">
      ...
      <p class="hero__subtitle">
        Каспи бот следит за конкурентами на Kaspi.kz и обновляет цены от 1 минуты: автоснижение и автоповышение. Ниже минимума по товару не опустится. От 19 990 ₸/мес, 3 дня бесплатно.
      </p>
...
const benefits = [
  { icon: IDuoThumbsUp, title: 'Удобно', text: 'Автоматическое обновление цен от 1 минуты' },
