<template>
  <HomepageSection
    ...
    description="Ориентиры из обратной связи продавцов Kaspi.kz, не средние по базе кабинета. Итог зависит от категории, конкуренции и минимумов — не гарантия результата"
  >
